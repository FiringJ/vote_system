...
if(isset($_POST["submit"]) && $_POST["submit"] == '登录')
{
    ...
    {
        $sql = "select user_name,password from users where user_name = '$_POST[user_name]' and password = $_POST[password]";
        #$sql = "select user_name,password from users where user_name = $user and password = $psw";
        $result = mysqli_query($db,$sql);
        $num = mysqli_num_rows($result);
        $user_msg = mysqli_query($db,"select * from users where user_name = '$_POST[user_name]'");
...
<form action="Login.php" method="post">
    ...
    <div class="pg_body">
        ...
        <div class="can">
            ...
            <div class="reg"><a href="Register.php">还未注册？</a></div>
    </div>
